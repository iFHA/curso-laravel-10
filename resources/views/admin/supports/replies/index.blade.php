        ...
        <div class="flex flex-col gap-3 text-white">
                ...
                <div class="flex flex-col gap-4 bg-gray-900 rounded p-4">
                    ...
                    <div class="flex justify justify-between">
                        <div class="flex gap-2">
                            <div class="w-7 h-7 text-center rounded-full bg-red-500">{{ getInitials($reply['user']['name']) }}</div>
            ...
            <div class="py-4">
                <form action="{{ route('replies.store', ['id' => $support->id]) }}" method="post">
                    ...
                    <a href="{{ route('supports.index') }}" class="hover:shadow-form rounded-md bg-[#6A64F1] py-3 px-8 text-base font-semibold text-white outline-none">
                        Voltar
                    </a>
                </form>
            </div>
